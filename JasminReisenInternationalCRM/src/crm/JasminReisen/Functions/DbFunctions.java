...
public class DbFunctions {
	...
	public static void createTrip(TripEntryFrame frame) {
		...
		/*
		 * String newDateString1 = date1.substring(6, 10) + "-" +
		 * date1.substring(3,5) + "-" + date1.substring(0,2); String
		 * newDateString2 = date2.substring(6, 10) + "-" + date2.substring(3,5)
		 * + "-" + date2.substring(0,2); String newDateString3 =
		 * date3.substring(6, 10) + "-" + date3.substring(3,5) + "-" +
		 * date3.substring(0,2); System.out.println(date1);
		 * System.out.println(date2); System.out.println(date3);
		 */
		sql = "INSERT INTO Reisen (Reisebeginn, Reiseende, Zielort, TransportmittelID, "
				...
				+ "VALUES ('" + date1 + "', '" + date2 + "', " + "'" + frame.getZielortField().getText() + "', " + "'"
				+ frame.getTransportmittelIdBox().getSelectedIndex() + "', " + "'" + frame.getPlaetzeField().getText()
				+ "', " + "'" + date3 + "', " + "'" + frame.getTripNameField().getText() + "', " + "'"
				+ frame.getBeschreibungArea().getText() + "', " + "'" + frame.getRegionBox().getSelectedIndex() + "', "
				+ "'" + frame.getThemaBox().getSelectedIndex() + "', " + "'" + frame.getKlimaIdBox().getSelectedIndex()
				+ "', " + "'" + frame.getPreisField().getText() + "', " + "'" + frame.getHotelIdBox().getSelectedIndex()
				+ "'" + ");";
